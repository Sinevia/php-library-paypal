...
class PayPal{
    ...
    //=====================================================================//
    function __construct($is_test=true){
        if($is_test==true){
    ...
    //=====================================================================//
        ...
        */
    function status(){
        if(isset($_GET["pp_a"])&&$_GET["pp_a"]=="success")return "success";
        if(isset($_GET["pp_a"])&&$_GET["pp_a"]=="cancel")return "cancel";
        if(isset($_GET["pp_a"])&&$_GET["pp_a"]=="notify")return "notify";
        return false;
    }
    ...
    //=====================================================================//
        ...
        */
    function verify_ipn(){
        $url = parse_url($this->paypal_url); $host=$url["host"]; $path = $url["path"];
        ...
        */
        ...
        if($fp===false){ if($this->log)$this->write_log("failed", "No Connection"."\r\n\r\nPOST DATA:\r\n\r\n".var_export($_POST,true)); $this->ipn_error="no_connection"; return false; }
        ...
        // START: Failed
        if($this->log)$this->write_log("failed",$result."\r\n\r\nPOST DATA:\r\n\r\n".var_export($_POST,true));
    ...
    private function write_log($success,$msg){
        ...
        if(file_exists($log_file)){$logs = file_get_contents($log_file); $msg = $logs.$msg; }
